$(document).ready(function () {
  ...
  $("#div_id_service")
    .children("div")
    .addClass("d-flex flex-row flex-wrap service");
  $(".d-flex.flex-row.service")
    .children()
    .children("input")
    .addClass("time m-3");
  ...
  $("#div_id_spec_service")
    .children("div")
    .addClass("d-flex flex-row flex-wrap special");
  $(".d-flex.flex-row.special")
    .children()
    .children("input")
    .addClass("special m-3");
  ...
  $("#more_items").click(function () {
    $(".d-none.justify-content-around.row:first")
      .addClass("d-flex")
      .removeClass("d-none");
  ...
  $("#less_items").click(function () {
    $(".justify-content-around.d-flex:last")
      .addClass("d-none")
      .removeClass("d-flex");
  ...
  $(".input-group-append")
    .children("span")
    .addClass("stripe-style-input small")
